                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    ...
                                                    <a href="mailto:<?= esc($student['email'] ?? '') ?>" class="btn btn-outline-success" title="Send Message">
                                                        <i class="bi bi-envelope"></i>
                                                    </a>
                                                    <a href="<?= base_url('teacher/editGrade/' . (isset($student['id']) ? $student['id'] : 1)) ?>" class="btn btn-outline-warning" title="Edit Grade">
