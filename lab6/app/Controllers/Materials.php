        ...
        if ($this->request->getMethod() === 'POST') {
            ...
            if ($this->validate($rules)) {
                ...
                if ($uploadedFile && $uploadedFile->isValid()) {
                    ...
                    $errorMessages = [
                        UPLOAD_ERR_INI_SIZE => 'File size exceeds the maximum allowed size (10MB).',
                        UPLOAD_ERR_FORM_SIZE => 'File size exceeds the maximum allowed size.',
                    ...
                    $errorMessage = isset($errorMessages[$error]) ? $errorMessages[$error] : 'Unknown upload error occurred.';
